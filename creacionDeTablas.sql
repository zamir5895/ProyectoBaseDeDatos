...
ALTER TABLE Receta
    ADD CONSTRAINT fk_key_compuesta FOREIGN KEY (dniMedico, dniPaciente, idConsultorio, idCita)
        REFERENCES Cita(dniMedico, dniPaciente, idConsultorio, id),
    ADD CONSTRAINT pk_key_receta  PRIMARY KEY (id, idCita, dniMedico, dniPaciente, idConsultorio);
...
ALTER TABLE Contiene
    ...
    ADD CONSTRAINT fk_compuesta FOREIGN KEY (idReceta, dniMedico, dniPaciente, idConsultorio, idCita) REFERENCES Receta(id, dniMedico, dniPaciente, idConsultorio, idCita),
    ADD CONSTRAINT pk_key_contiene PRIMARY KEY (idReceta, idMedicamento, idCita, idConsultorio, dniPaciente, dniMedico);
